...
class Admin::ReportsControllerTest < ActionDispatch::IntegrationTest
  setup do
    @headers_hash = { Authorization: ActionController::HttpAuthentication::Basic.encode_credentials('admin', 'admin') }
    @report = reports(:one)
  end

  test 'should get index' do
    get admin_reports_path, headers: @headers_hash
    assert_response :success
  end

  test 'should get show' do
    get admin_report_path(@report), headers: @headers_hash
    assert_response :success
  end
  ...
  test 'should agree a report' do
    ...
    assert_difference('Article.count', -1) do
      put agree_admin_report_path(@report),headers: @headers_hash
    end
