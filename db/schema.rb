...
ActiveRecord::Schema.define(version: 2019_06_08_051541) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "tag_list"
    t.index "to_tsvector('english'::regconfig, (((((name)::text || ' '::text) || (COALESCE(profile, ' '::character varying))::text) || ' '::text) || (COALESCE(tag_list, ' '::character varying))::text))", name: "gin_index_on_users", using: :gin
